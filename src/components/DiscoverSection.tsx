...
const signposts: Signpost[] = [
  // Row 1 — wide left
  { title: "The Cornerhouse",   subtitle: "Late nights, big floors",           imageUrl: "/images/club-y-image-5.webp",   href: "#cornerhouse",    wide: true },
  { title: "The Quadrant",      subtitle: "Outdoor terrace under the stars",   imageUrl: "/images/club-y-image-6.webp",   href: "#quadrant" },
